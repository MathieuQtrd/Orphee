...
class Router 
{
    public function route()
    {
        ...
        if(strpos($url, '/PHP_orphee_18/PHPoo/CRUD_bibliotheque') === 0) {
            $url = substr($url, strlen('/PHP_orphee_18/PHPoo/CRUD_bibliotheque'));
            // echo '<pre>'; print_r($url); echo '</pre>';
        ...
        */
        ...
        $controllerName = (isset($segments[0]) && $segments[0] != '') ? ucfirst($segments[0]) . 'Controller' : 'AbonneController'; // 'IndexController

...
INSERT INTO abonne (id_abonne, prenom, nom, email) VALUES
(1, 'Guillaume', 'Laborde', 'glaborde@mail.fr'),
(2, 'Benoit', 'Gallet', 'bgaller@mail.fr'),
(3, 'Chloe', 'Winter', 'cwinter@mail.fr'),
(4, 'Laura', 'Dubar', 'ldubar@mail.fr');

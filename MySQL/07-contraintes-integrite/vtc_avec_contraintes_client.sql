...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 16 jan. 2026 à 09:25
...
ALTER TABLE `association_vehicule_conducteur`
  ADD CONSTRAINT `association_vehicule_conducteur_ibfk_1` FOREIGN KEY (`id_conducteur`) REFERENCES `conducteur` (`id_conducteur`) ON DELETE RESTRICT ON UPDATE CASCADE,
